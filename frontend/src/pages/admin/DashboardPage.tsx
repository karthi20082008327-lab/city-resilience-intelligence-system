  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-[10px] text-slate-400 uppercase tracking-wider mt-0.5">Score</span>
      </div>
    </div>
  )
}
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((stat, i) => (
          <motion.div
            ...
            className="uc-card p-5 group hover:border-slate-300 transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        >
          <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-5">City Status</h3>
          <div className="flex items-center justify-around mb-5">
            <div className="text-center">
              <GaugeRing value={data.city_health_score} color="#22c55e" />
              <p className="text-[11px] text-slate-400 mt-2">Health</p>
            </div>
            <div className="text-center">
              <GaugeRing value={data.risk_score} color="#ef4444" />
              <p className="text-[11px] text-slate-400 mt-2">Risk</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            {data.ai_insights.length === 0 && (
              <p className="text-xs text-slate-400 text-center py-2">No active insights</p>
            )}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="uc-card p-6"
        >
          <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-5">7-Day Trend</h3>
        ...
        <motion.div
          ...
          className="uc-card p-6"
        >
          <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-5">By Category</h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-800 capitalize truncate">{dept.replace(/_/g, ' ')}</p>
